...
async def BOQ_EXTRACTOR_SERVICE(file_path: str, custom_instructions: str = "") -> Tuple[str, str, float, float, list]:
    ...
    combined_json_path, combined_excel_path = combine_outputs_across_sheets(file_path, match_filename="final_product_entries.json")
...
if __name__ == "__main__":
    ...
    # file_path = "/home/student2/Documents/GitHub/1st_AI_Project_Kothari/boq_extraction_2/pipeline_copy_2/inputs/BERGER -RISHRA -SOR-BOQ-317047_Anx_DTL.xlsx"
    file_path = "/home/student2/Documents/GitHub/1st_AI_Project_Kothari/boq_extraction_2/pipeline_copy_2/inputs/Tolani projects IOCL EIL Barauni without rates.xlsx"
