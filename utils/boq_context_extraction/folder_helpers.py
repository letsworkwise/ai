...
def create_intermediate_results_folders(output_folder: str) -> str:
    ...
    search_logs_folder = os.path.join(output_folder, "search_logs")

    os.makedirs(chunking_folder, exist_ok=True)
    os.makedirs(boundaries_folder, exist_ok=True)
    os.makedirs(final_output_folder, exist_ok=True)
    os.makedirs(search_logs_folder, exist_ok=True)
    return chunking_folder, boundaries_folder, final_output_folder, search_logs_folder